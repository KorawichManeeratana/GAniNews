        ...
        <div>
            <div className="flex mt-2">
                <button
                    ...
                    className="w-64 flex-1 bg-gray-200 text-gray-800 font-semibold py-3 px-6 shadow-md hover:text-white hover:bg-violet-500 hover:shadow-lg transition duration-300"
                >
                    Manage Post
                </button>
